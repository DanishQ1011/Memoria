        ...
        <div className="flex max-sm:justify-center ">
          <div className="flex flex-col sm:justify-center ">
            <div className="relative lg:w-[410px] sm:max-w-xl sm:mx-auto md:mb-[100px] lg:mb-30 max-sm:mb-[50px]">
              <div
                className="relative md:p-5 bg-gray-800 shadow-lg sm:rounded-2xl max-sm:p-10 max-sm:rounded-md bg-opacity-60 border border-gray-800"
                style={{ backdropFilter: 'blur(20px)' }}
              >
                <div className="mb-4 md:mb-10 lg:mb-4">
                  <p
                    className="flex justify-start items-center gap-3  text-blue-500 text-lg lg:text-2xl"
                  >
                    <svg
                      className="h-[24px] mt-[3px]"
                      ...
                      {!showLoginForm && (
                        <div className="grid gap-4 grid-cols-2 sm:gap-6 mb-2">
                          <div>
                            <label
                              htmlFor="firstname"
                              className="block mb-1 text-sm sm:mb-2 sm:text-base font-medium text-gray-900 dark:text-white"
                            >
                              First name
                            </label>
                            <input
                      ...
                      <div>
                        <h1 className="text-center">
                          ...
                          <span
                            ...
                            onClick={() => toggleLoginForm()} // Toggle the form
                          >
                            Log in
                          </span>{' '}
                        </h1>
