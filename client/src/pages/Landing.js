...
const Landing = ({ showLoginForm, toggleLoginForm }) => {
                    ...
                    <div className="py-3 text-sm sm:text-base md:text-lg space-y-4 text-white">
                      {!showLoginForm && (
                        <div className="grid gap-4 grid-cols-2 sm:gap-6 mb-2">
                          <div>
                            <label htmlFor="firstname" className="block mb-1 text-sm sm:mb-2 sm:text-base font-medium text-gray-900 dark:text-white">
                              First name
                            </label>
                            <input
                              type="text"
                          ...
                          <div>
                            <label htmlFor="lastname" className="block mb-1 text-sm sm:mb-2 sm:text-base font-medium text-gray-900 dark:text-white">
                              Last name
                            </label>
                            <input
                              type="text"
                      ...
                      {!showLoginForm && (
                        <div>
                          <h1 className="text-center">
                            ...
                            <span className="text-blue-500 cursor-pointer hover:text-blue-300" onClick={() => toggleLoginForm()}>Log in</span>
                          </h1>
                        </div>
                      )}
                      {showLoginForm && (
                        <div>
                          <h1 className="text-center">
                            ...
                            <span className="text-blue-500 cursor-pointer hover:text-blue-300" onClick={() => toggleLoginForm()}>Sign up!</span>
                          </h1>
                        </div>
                      )}
                    </div>
